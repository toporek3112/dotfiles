...
for i = 1, 10 do
	...
	-- main row: SUPER + [0-9]
	hl.bind(vars.keys.mainMod .. " + " .. key, hl.dsp.focus({ workspace = i }))
	-- main row move
	hl.bind(vars.keys.mainMod .. " + SHIFT + " .. key, hl.dsp.window.move({ workspace = i }))

	-- numpad: SUPER + KP_*
	local kp = vars.keypad[i]
	if kp then
		hl.bind(vars.keys.mainMod .. " + " .. kp, hl.dsp.focus({ workspace = i }))
		hl.bind(vars.keys.mainMod .. " + SHIFT + " .. kp, hl.dsp.window.move({ workspace = i }))
	end
end
